...
public class CustomerRepositoryTest {
  ...
  void setUp() {
    ...
    testCustomer = Customer.builder().parentId(1).childId(2).build();
  ...
  void testFindById_NotFound() {
    ...
    Optional<Customer> retrievedCustomer =
        customerRepository.findById(999); // Assuming 999 does not exist
