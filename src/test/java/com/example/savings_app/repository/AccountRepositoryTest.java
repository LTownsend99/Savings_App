...
public class AccountRepositoryTest {
    ...
    void testFindById_NotFound() {
        ...
        Optional<Account> retrievedAccount = accountRepository.findById(999); // Assuming 999 doesn't exist in DB
    ...
    void testFindByEmail_NotFound() {
        ...
        Optional<Account> retrievedAccount = accountRepository.findByEmail("non.existing.email@example.com");
